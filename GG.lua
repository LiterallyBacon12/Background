...
do
	a.a = function()
		...
		g.Image = function(j, k, n, o, p, q)
			local r = h("Frame", {Size=UDim2.new(0, 0, 0, 0),BackgroundTransparency=1}, {h("ImageLabel", {Size=UDim2.new(1, 0, 1, 0),BackgroundTransparency=1,ScaleType="Crop",ThemeTag=((g.Icon(j) and {ImageColor3=(q and "Text")}) or nil)}, {h("UICorner", {CornerRadius=UDim.new(0, n)})})});
			if g.Icon(j) then
	...
	a.d = function()
		...
		e.Input = function(i, j, k, n)
			local o, p = 10;
			if (j and (j ~= "")) then
				p = g("ImageLabel", {Image=f.Icon(j)[1],ImageRectSize=f.Icon(j)[2].ImageRectSize,ImageRectOffset=f.Icon(j)[2].ImageRectPosition,Size=UDim2.new(0, 21, 0, 21),BackgroundTransparency=1,ThemeTag={ImageColor3="Icon"}});
			end
			local q = g("TextBox", {BackgroundTransparency=1,TextSize=18,FontFace=Font.new(f.Font, Enum.FontWeight.Regular),Size=UDim2.new(1, (p and -29) or 0, 1, 0),PlaceholderText=i,ClearTextOnFocus=false,ClipsDescendants=true,MultiLine=false,TextXAlignment="Left",ThemeTag={PlaceholderColor3="PlaceholderText",TextColor3="Text"}});
			local r = g("Frame", {Size=UDim2.new(1, 0, 0, 42),Parent=k,BackgroundTransparency=1}, {g("Frame", {Size=UDim2.new(1, 0, 1, 0),BackgroundTransparency=1}, {f.NewRoundFrame(o, "Squircle", {ThemeTag={ImageColor3="Accent"},Size=UDim2.new(1, 0, 1, 0),ImageTransparency=0.45}),f.NewRoundFrame(o, "SquircleOutline", {ThemeTag={ImageColor3="Outline"},Size=UDim2.new(1, 0, 1, 0),ImageTransparency=0.9}),f.NewRoundFrame(o, "Squircle", {Size=UDim2.new(1, 0, 1, 0),Name="Frame",ImageColor3=Color3.new(1, 1, 1),ImageTransparency=0.95}, {g("UIPadding", {PaddingLeft=UDim.new(0, 12),PaddingRight=UDim.new(0, 12)}),g("UIListLayout", {FillDirection="Horizontal",Padding=UDim.new(0, 8),VerticalAlignment="Center",HorizontalAlignment="Left"}),p,q})})});
		...
		e.Label = function(i, j, k)
			...
			local p = g("TextLabel", {BackgroundTransparency=1,TextSize=18,FontFace=Font.new(f.Font, Enum.FontWeight.Regular),Size=UDim2.new(1, (o and -29) or 0, 1, 0),TextXAlignment="Left",ThemeTag={TextColor3="Text"},Text=i});
		...
		e.ScrollSlider = function(i, j, k, n)
			local o = g("Frame", {Size=UDim2.new(0, n, 1, -k.UIPadding * 2),BackgroundTransparency=1,Position=UDim2.new(1, -k.UIPadding / 3, 0, k.UIPadding),AnchorPoint=Vector2.new(1, 0),Parent=j,ZIndex=999,Active=true});
			local p = f.NewRoundFrame(n / 2, "Squircle", {Size=UDim2.new(1, 0, 0, 0),ImageTransparency=0.85,ThemeTag={ImageColor3="Text"},Parent=o});
			local q, r, s, t = g("Frame", {Size=UDim2.new(1, 12, 1, 12),Position=UDim2.new(0.5, 0, 0.5, 0),AnchorPoint=Vector2.new(0.5, 0.5),BackgroundTransparency=1,Active=true,ZIndex=999,Parent=p}), function()
				local q = i;
	...
	a.f = function()
		...
		b.new = function(i, j, k)
			...
			if i.Icon then
				...
				s = d("ImageLabel", {Size=UDim2.new(0, 24, 0, 24),BackgroundTransparency=1,LayoutOrder=-1,ThemeTag=t});
				...
				elseif c.Icon(tostring(i.Icon))[1] then
	...
	a.g = function()
		...
		e.New = function(f)
			local g = {Title=(f.Title or "Notification"),Content=(f.Content or nil),Icon=(f.Icon or nil),Background=f.Background,Duration=(f.Duration or 5),Buttons=(f.Buttons or {}),CanClose=true,UIElements={},Closed=false};
			...
			if g.Icon then
				if (b.Icon(g.Icon) and b.Icon(g.Icon)[2]) then
					j = c("ImageLabel", {Size=UDim2.new(0, 26, 0, 26),Position=UDim2.new(0, e.UIPadding, 0, e.UIPadding),BackgroundTransparency=1,Image=b.Icon(g.Icon)[1],ImageRectSize=b.Icon(g.Icon)[2].ImageRectSize,ImageRectOffset=b.Icon(g.Icon)[2].ImageRectPosition,ThemeTag={ImageColor3="Text"}});
				elseif string.find(g.Icon, "rbxassetid") then
					j = c("ImageLabel", {Size=UDim2.new(0, 26, 0, 26),BackgroundTransparency=1,Position=UDim2.new(0, e.UIPadding, 0, e.UIPadding),Image=g.Icon});
				end
			end
			local k;
			if g.CanClose then
			...
			local p = c("CanvasGroup", {Size=UDim2.new(1, 0, 0, 0),Position=UDim2.new(2, 0, 1, 0),AnchorPoint=Vector2.new(0, 1),AutomaticSize="Y",BackgroundTransparency=0.25,ThemeTag={BackgroundColor3="Accent"}}, {c("ImageLabel", {Name="Background",Image=g.Background,BackgroundTransparency=1,Size=UDim2.new(1, 0, 1, 0),ScaleType="Crop"}),i,h,o,j,k,n});
	...
	a.h = function()
		...
		b.new = function(f)
			local g, h = {Title=(f.Title or "Dialog"),Content=f.Content,Icon=f.Icon,Thumbnail=f.Thumbnail,Buttons=f.Buttons}, a.load("e").Init(f.WindUI.ScreenGui.Popups);
			...
			local o = d("TextLabel", {AutomaticSize="XY",BackgroundTransparency=1,Text=g.Title,FontFace=Font.new(c.Font, Enum.FontWeight.SemiBold),ThemeTag={TextColor3="Text"},TextSize=20});
	...
	a.i = function()
		...
		return function(g)
			local h = {Title=g.Title,Desc=(g.Desc or nil),Hover=g.Hover,Thumbnail=g.Thumbnail,ThumbnailSize=(g.ThumbnailSize or 80),Image=g.Image,ImageSize=(g.ImageSize or 22),Color=g.Color,Scalable=g.Scalable,UIPadding=12,UICorner=12,UIElements={}};
			...
			h.Lock = function(s)
				...
				e(h.UIElements.Main.Lock.ImageLabel, 0.08, {ImageTransparency=0}):Play();
				e(h.UIElements.Main.Lock.TextLabel, 0.08, {TextTransparency=0}):Play();
	...
	a.k = function()
		...
		h.New = function(i, j)
			...
			k.ToggleFrame = a.load("i")({Title=k.Title,Desc=k.Desc,Window=j.Window,Parent=j.Parent,TextOffset=44,Hover=false});
			local n = true;
			if (k.Value == nil) then
				k.Value = false;
			end
	...
	a.m = function()
		...
		f.New = function(i, j)
			...
			k.KeybindFrame = a.load("i")({Title=k.Title,Desc=k.Desc,Parent=j.Parent,TextOffset=85,Hover=k.CanChange});
	...
	a.n = function()
		...
		local g, h = f.Button, f.Input;
		e.New = function(i, j)
			local k, n = {__type="Input",Title=(j.Title or "Input"),Desc=(j.Desc or nil),Locked=(j.Locked or false),InputIcon=(j.InputIcon or false),PlaceholderText=(j.Placeholder or "Enter Text..."),Value=(j.Value or ""),Callback=(j.Callback or function()
			end),ClearTextOnFocus=(j.ClearTextOnFocus or false),UIElements={}}, true;
			k.InputFrame = a.load("i")({Title=k.Title,Desc=k.Desc,Parent=j.Parent,TextOffset=190,Hover=false});
	...
	a.o = function()
		...
		j.New = function(k, n)
			...
			o.DropdownFrame = a.load("i")({Title=o.Title,Desc=o.Desc,Parent=n.Parent,TextOffset=190,Hover=false});
	...
	a.q = function()
		...
		q.New = function(aa, ab)
			...
			ac.ColorpickerFrame = a.load("i")({Title=ac.Title,Desc=ac.Desc,Parent=ab.Parent,TextOffset=40,Hover=false});
			ac.UIElements.Colorpicker = b.NewRoundFrame(q.UICorner, "Squircle", {ImageTransparency=0,Active=true,ImageColor3=ac.Default,Parent=ac.ColorpickerFrame.UIElements.Main,Size=UDim2.new(0, 30, 0, 30),AnchorPoint=Vector2.new(1, 0.5),Position=UDim2.new(1, -ac.ColorpickerFrame.UIPadding / 2, 0.5, 0),ZIndex=2}, nil, true);
			ac.Lock = function(ae)
				ad = false;
	...
	a.r = function()
		...
		ad.New = function(ae, af)
			local ag = {__type="Section",Title=(af.Title or "Section"),TextXAlignment=(af.TextXAlignment or "Left"),TextSize=(af.TextSize or 19),UIElements={}};
			ag.UIElements.Main = ab("TextLabel", {BackgroundTransparency=1,TextXAlignment=ag.TextXAlignment,AutomaticSize="Y",TextSize=ag.TextSize,ThemeTag={TextColor3="Text"},FontFace=Font.new(aa.Font, Enum.FontWeight.SemiBold),Parent=af.Parent,Size=UDim2.new(1, 0, 0, 0),Text=ag.Title}, {ab("UIPadding", {PaddingTop=UDim.new(0, 4),PaddingBottom=UDim.new(0, 2)})});
	...
	a.s = function()
		...
		c.New = function(d)
			local e, f, g = {Title=(d.Title or "Tab"),Desc=d.Desc,Icon=d.Icon,Locked=d.Locked,ShowTabTitle=d.ShowTabTitle,Selected=false,Index=nil,Parent=d.Parent,UIElements={},Elements={},ContainerFrame=nil}, c.Window, c.WindUI;
			...
			if (e.Icon and ac.Icon(e.Icon)) then
				j = ad("ImageLabel", {ImageTransparency=((not e.Locked and 0.5) or 0.7),Image=ac.Icon(e.Icon)[1],ImageRectOffset=ac.Icon(e.Icon)[2].ImageRectPosition,ImageRectSize=ac.Icon(e.Icon)[2].ImageRectSize,Size=UDim2.new(0, 18, 0, 18),LayoutOrder=1,ThemeTag={ImageColor3="Text"},BackgroundTransparency=1,Parent=e.UIElements.Main});
				e.UIElements.Main.TextLabel.Size = UDim2.new(1, -30, 0, 0);
				i = -30;
			elseif (e.Icon and string.find(e.Icon, "rbxassetid://")) then
				j = ad("ImageLabel", {ImageTransparency=((not e.Locked and 0.5) or 0.7),Image=e.Icon,Size=UDim2.new(0, 18, 0, 18),LayoutOrder=1,ThemeTag={ImageColor3="Text"},BackgroundTransparency=1,Parent=e.UIElements.Main});
				e.UIElements.Main.TextLabel.Size = UDim2.new(1, -30, 0, 0);
				i = -30;
			end
			e.UIElements.ContainerFrame = ad("ScrollingFrame", {Size=UDim2.new(1, 0, 1, (e.ShowTabTitle and -((f.UIPadding * 2.4) + 12)) or 0),BackgroundTransparency=1,ScrollBarThickness=0,ElasticBehavior="Never",CanvasSize=UDim2.new(0, 0, 0, 0),AnchorPoint=Vector2.new(0, 1),Position=UDim2.new(0, 0, 1, 0),AutomaticCanvasSize="Y",ScrollingDirection="Y"}, {ad("UIPadding", {PaddingTop=UDim.new(0, f.UIPadding * 1.2),PaddingLeft=UDim.new(0, f.UIPadding * 1.2),PaddingRight=UDim.new(0, f.UIPadding * 1.2),PaddingBottom=UDim.new(0, f.UIPadding * 1.2)}),ad("UIListLayout", {SortOrder="LayoutOrder",Padding=UDim.new(0, 6)})});
			...
			local k = {Button=a.load("j"),Toggle=a.load("k"),Slider=a.load("l"),Keybind=a.load("m"),Input=a.load("n"),Dropdown=a.load("o"),Code=a.load("p"),Colorpicker=a.load("q"),Section=a.load("r")};
			e.Paragraph = function(n, o)
				...
				local p, q = {__type="Paragraph",Title=(o.Title or "Paragraph"),Desc=(o.Desc or nil),Locked=(o.Locked or false)}, a.load("i")(o);
				p.ParagraphFrame = q;
				if (o.Buttons and (#o.Buttons > 0)) then
					local r = ad("Frame", {Size=UDim2.new(1, 0, 0, 38),BackgroundTransparency=1,Position=UDim2.new(0, 0, 0, (o.Image and (q.ImageSize > q.UIElements.Main.Title.AbsoluteSize.Y) and (q.ImageSize + q.UIPadding)) or (q.UIElements.Main.Title.AbsoluteSize.Y + q.UIPadding + (o.ThumbnailSize or 0))),Parent=q.UIElements.Main}, {ad("UIListLayout", {Padding=UDim.new(0, 10),FillDirection="Vertical"})});
			...
			task.spawn(function()
				local p = ad("Frame", {BackgroundTransparency=1,Size=UDim2.new(1, 0, 1, -f.UIElements.Main.Main.Topbar.AbsoluteSize.Y),Parent=e.UIElements.ContainerFrame}, {ad("UIListLayout", {Padding=UDim.new(0, 8),SortOrder="LayoutOrder",VerticalAlignment="Center",HorizontalAlignment="Center",FillDirection="Vertical"}),ad("ImageLabel", {Size=UDim2.new(0, 48, 0, 48),Image=ac.Icon("frown")[1],ImageRectOffset=ac.Icon("frown")[2].ImageRectPosition,ImageRectSize=ac.Icon("frown")[2].ImageRectSize,ThemeTag={ImageColor3="Text"},BackgroundTransparency=1,ImageTransparency=0.4}),ad("TextLabel", {AutomaticSize="XY",Text="This tab is empty",ThemeTag={TextColor3="Text"},TextSize=18,TextTransparency=0.4,BackgroundTransparency=1,FontFace=Font.new(ac.Font, Enum.FontWeight.Medium)})});
	...
	a.t = function()
		...
		ab.new = function(af, ag, b)
			...
			local g = ac.NewRoundFrame(c.Radius, "Squircle", {Size=UDim2.new(1, 0, 1, 0),ThemeTag={ImageColor3="Accent"},ImageTransparency=0}, {ad("Frame", {Size=UDim2.new(1, 0, 1, 0),BackgroundTransparency=1,Visible=false}, {ad("Frame", {Size=UDim2.new(1, 0, 0, 46),BackgroundTransparency=1}, {ad("Frame", {Size=UDim2.new(1, 0, 1, 0),BackgroundTransparency=1}, {ad("ImageLabel", {Image=ac.Icon("search")[1],ImageRectSize=ac.Icon("search")[2].ImageRectSize,ImageRectOffset=ac.Icon("search")[2].ImageRectPosition,BackgroundTransparency=1,ThemeTag={ImageColor3="Text"},ImageTransparency=0.2,Size=UDim2.new(0, c.IconSize, 0, c.IconSize)}),d,e,ad("UIListLayout", {Padding=UDim.new(0, c.Padding),FillDirection="Horizontal",VerticalAlignment="Center"}),ad("UIPadding", {PaddingLeft=UDim.new(0, c.Padding),PaddingRight=UDim.new(0, c.Padding)})})}),ad("Frame", {BackgroundTransparency=1,AutomaticSize="Y",Size=UDim2.new(1, 0, 0, 0),Name="Results"}, {ad("Frame", {Size=UDim2.new(1, 0, 0, 1),ThemeTag={BackgroundColor3="Outline"},BackgroundTransparency=0.9,Visible=false}),f,ad("UISizeConstraint", {MaxSize=Vector2.new(c.Width, c.MaxHeight)})}),ad("UIListLayout", {Padding=UDim.new(0, 0),FillDirection="Vertical"})})});
	...
	a.u = function()
		...
		return function(ag)
			...
			local k, n, o, p;
			if not j then
				o = ad("ImageLabel", {Image="",Size=UDim2.new(0, 22, 0, 22),Position=UDim2.new(0.5, 0, 0.5, 0),LayoutOrder=-1,AnchorPoint=Vector2.new(0.5, 0.5),BackgroundTransparency=1,Name="Icon"});
				OpenButtonTitle = ad("TextLabel", {Text=b.Title,TextSize=17,FontFace=Font.new(ac.Font, Enum.FontWeight.Medium),BackgroundTransparency=1,AutomaticSize="XY"});
				...
				k = ad("Frame", {Size=UDim2.new(0, 0, 0, 0),Position=UDim2.new(0.5, 0, 0, 28),AnchorPoint=Vector2.new(0.5, 0.5),Parent=ag.Parent,BackgroundTransparency=1,Active=true,Visible=false});
				n = ad("TextButton", {Size=UDim2.new(0, 0, 0, 44),AutomaticSize="X",Parent=k,Active=false,BackgroundTransparency=0.25,ZIndex=99,BackgroundColor3=Color3.new(0, 0, 0)}, {ad("UICorner", {CornerRadius=UDim.new(1, 0)}),ad("UIStroke", {Thickness=1,ApplyStrokeMode="Border",Color=Color3.new(1, 1, 1),Transparency=0}, {ad("UIGradient", {Color=ColorSequence.new(Color3.fromHex("40c9ff"), Color3.fromHex("e81cff"))})}),OpenButtonDrag,OpenButtonDivider,ad("UIListLayout", {Padding=UDim.new(0, 4),FillDirection="Horizontal",VerticalAlignment="Center"}),ad("TextButton", {AutomaticSize="XY",Active=true,BackgroundTransparency=1,Size=UDim2.new(0, 0, 0, 36),BackgroundColor3=Color3.new(1, 1, 1)}, {ad("UICorner", {CornerRadius=UDim.new(1, -4)}),o,ad("UIListLayout", {Padding=UDim.new(0, b.UIPadding),FillDirection="Horizontal",VerticalAlignment="Center"}),OpenButtonTitle,ad("UIPadding", {PaddingLeft=UDim.new(0, 12),PaddingRight=UDim.new(0, 12)})}),ad("UIPadding", {PaddingLeft=UDim.new(0, 4),PaddingRight=UDim.new(0, 4)})});
			...
			if b.Author then
				ad("TextLabel", {Text=b.Author,FontFace=Font.new(ac.Font, Enum.FontWeight.Medium),BackgroundTransparency=1,TextTransparency=0.4,AutomaticSize="XY",Parent=b.UIElements.Main.Main.Topbar.Left.Title,TextXAlignment="Left",TextSize=14,LayoutOrder=2,ThemeTag={TextColor3="Text"}});
			end
			task.spawn(function()
				if b.Icon then
...
-- Yhh:
			...
			b:CreateTopbarButton("minus", function()
				...
				if not af then
					af = not af;
					ag.WindUI({Title="Minimize",Content=("You've closed the Window. " .. C),Icon="eye-off",Duration=5});
				end
			end, 997);
			b.Open = function(C)
				task.spawn(function()
			...
			b.EditOpenButton = function(C, D)
				if (n and (n.Parent ~= nil)) then
					local E = {Title=D.Title,Icon=(D.Icon or b.Icon),Enabled=D.Enabled,Position=D.Position,Draggable=D.Draggable,OnlyMobile=D.OnlyMobile,CornerRadius=(D.CornerRadius or UDim.new(1, 0)),StrokeThickness=(D.StrokeThickness or 2),Color=(D.Color or ColorSequence.new(Color3.fromHex("40c9ff"), Color3.fromHex("e81cff")))};
			...
			b.Divider = function(E)
				local F = ad("Frame", {Size=UDim2.new(1, 0, 0, 1),Position=UDim2.new(0.5, 0, 0, 0),AnchorPoint=Vector2.new(0.5, 0),BackgroundTransparency=0.9,ThemeTag={BackgroundColor3="Text"}});
				ad("Frame", {Parent=b.UIElements.SideBar.Frame,Size=UDim2.new(1, -7, 0, 1),BackgroundTransparency=1}, {F});
			end;
			local E = a.load("e").Init(b);
			b.Dialog = function(F, G)
				local H, I = {Title=(G.Title or "Dialog"),Content=G.Content,Buttons=(G.Buttons or {})}, E.Create();
				local J, K = (ad("Frame", {Size=UDim2.new(1, 0, 0, 0),AutomaticSize="Y",BackgroundTransparency=1,Parent=I.UIElements.Main}, {ad("UIListLayout", {FillDirection="Horizontal",Padding=UDim.new(0, I.UIPadding),VerticalAlignment="Center"})}));
				if (G.Icon and ac.Icon(G.Icon)[2]) then
					K = ad("ImageLabel", {Image=ac.Icon(G.Icon)[1],ImageRectSize=ac.Icon(G.Icon)[2].ImageRectSize,ImageRectOffset=ac.Icon(G.Icon)[2].ImageRectPosition,ThemeTag={ImageColor3="Text"},Size=UDim2.new(0, 26, 0, 26),BackgroundTransparency=1,Parent=J});
				end
				I.UIElements.UIListLayout = ad("UIListLayout", {Padding=UDim.new(0, 18.4),FillDirection="Vertical",HorizontalAlignment="Left",Parent=I.UIElements.Main});
				ad("UISizeConstraint", {MinSize=Vector2.new(180, 20),MaxSize=Vector2.new(400, math.huge),Parent=I.UIElements.Main});
				I.UIElements.Title = ad("TextLabel", {Text=H.Title,TextSize=19,FontFace=Font.new(ac.Font, Enum.FontWeight.SemiBold),TextXAlignment="Left",TextWrapped=true,RichText=true,Size=UDim2.new(1, (K and (-26 - I.UIPadding)) or 0, 0, 0),AutomaticSize="Y",ThemeTag={TextColor3="Text"},BackgroundTransparency=1,Parent=J});
				if H.Content then
					ad("TextLabel", {Text=H.Content,TextSize=18,TextTransparency=0.4,TextWrapped=true,RichText=true,FontFace=Font.new(ac.Font, Enum.FontWeight.Medium),TextXAlignment="Left",Size=UDim2.new(1, 0, 0, 0),AutomaticSize="Y",LayoutOrder=2,ThemeTag={TextColor3="Text"},BackgroundTransparency=1,Parent=I.UIElements.Main});
				end
				local L = ad("UIListLayout", {Padding=UDim.new(0, 10),FillDirection="Horizontal",HorizontalAlignment="Right"});
				local M, N, O = ad("Frame", {Size=UDim2.new(1, 0, 0, 40),AutomaticSize="None",BackgroundTransparency=1,Parent=I.UIElements.Main,LayoutOrder=4}, {L}), a.load("d").Button, {};
			...
			b:CreateTopbarButton("x", function()
				...
				b({Icon="trash-2",Title="Close Window",Content=[[Do you want to close this window? You will not be able to open it again.]],Buttons={{Title="Cancel",Callback=function()
...
local aa, ab, ac = {Window=nil,Theme=nil,Creator=a.load("a"),Themes=a.load("b"),Transparent=false,TransparencyValue=0.15}, game:GetService("RunService"), a.load("f");
...
aa.ScreenGui = af("ScreenGui", {Name="WindUI",Parent=d,IgnoreGuiInset=true,ScreenInsets="None"}, {af("Folder", {Name="Window"}),af("Folder", {Name="Dropdowns"}),af("Folder", {Name="KeySystem"}),af("Folder", {Name="Popups"}),af("Folder", {Name="ToolTips"})});
